...
/* GetAsyncKeyState(VK_ESCAPE)  bắt sự kiện phím Esc
					VK_LSHIFT	Phím sang trái.
					VK_RSHIFT	Phím sang phải.
					VK_LCONTROL	Phím điều khiển bên trái.
					VK_RCONTROL	Phím điều khiển bên phải.
					VK_LMENU	Phím menu bên trái.
					VK_RMENU	Phím menu bên phải. */
